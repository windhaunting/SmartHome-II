...
public class requestTimeBerkleyAlgo implements Runnable {
	...
	public void run() {
		...
		try {
			GwServerInterfaceImplRep.storeTimeStamps.add(stGatewayObj.provideTimeStamp());
			...
			try {
				GwServerInterfaceImplRep.storeTimeStamps.add(stSensorObj.provideTimeStamp());
			} catch (NullPointerException | RemoteException e) {
			...
			try {
				GwServerInterfaceImplRep.storeTimeStamps.add(stDeviceObj.provideTimeStamp());
			...
			try {
				GwServerInterfaceImplRep.storeTimeStamps.add(stDatabaseObj.provideTimeStamp());
			} catch (NullPointerException | RemoteException e) {
